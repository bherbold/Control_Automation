...
//=============================================================================================================================================================
    ...
    if (contador_acumulado >= sampleAverage) 
    {
        ...
        float sensorValue1;
        float percentage;
        sensorValue1 = analogRead(A0);   //connect Steam sensors to Analog 0
        percentage = sensorValue1/4095*100;
        Serial.print(percentage); //print the value to serial
        Serial.print(" ");

        // NEW TEMPERATURE SENSOR
        uint16_t val;
        double temp;
        val = analogRead(A1);//Connect LM35 on Analog 4
        temp = (double) ((val * (3.3 / 4095.0)) - 0.05)*100.0;
        Serial.println(temp);

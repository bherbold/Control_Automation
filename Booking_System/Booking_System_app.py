...
if check_password():
    ...
    df_sustainable = df_overview[
        df_overview['Estimated Emissions [ton/MWh]'] < df_overview['Estimated Emissions [ton/MWh]'].mean()]
    ...
    with tab2:
        ...
        st.markdown(
            'Given our pay-per-use tariff model, here are the hours in which the electricity price is below the daily average:\n')
    ...
    with tab3:
        ...
        st.markdown(
            'Here are the hours in which the emissions from electricity generation are below the daily average:\n')
